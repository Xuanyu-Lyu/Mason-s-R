---
title: Xuanyu's Contract for Mason's R 
...
- [ ] `r advdate(dayone, 1, topic)`
  - Finish Lab 1 by `r advdate(dayone, 3, assignment="monday")`
- [ ] `r advdate(dayone, 2, topic)`
  - Finish Lab 2 by `r advdate(dayone, 3, assignment="monday")`
- [ ]  `r advdate(dayone, 3, topic)`
  - Finish Lab 3  by `r advdate(dayone, 3, assignment="Tuesday")`
  - Finish portfolio piece 1 by `r advdate(dayone, 4, assignment="monday")`
- [ ] `r advdate(dayone, 4, topic)`
  - Finish Lab 4  by `r advdate(dayone, 5, assignment="monday")`
- [ ] `r advdate(dayone, 5, topic)`
  - Finish Lab 5  by `r advdate(dayone, 5, assignment="Tuesday")`
  - Finish portfolio piece 2 by `r advdate(dayone, 7, assignment="monday")`
- [ ] `r advdate(dayone, 6, topic)`
  - Finish Lab 6 by `r advdate(dayone, 6, assignment="monday")`
- [ ] `r advdate(dayone, 7, topic)`
  - Finish Lab 7 by `r advdate(dayone, 6, assignment="friday")`
  - Finish portfolio piece 3 by `r advdate(dayone, 8, assignment="monday")`
- [ ] `r advdate(dayone, 8, topic)`
  - Finish Lab 8 by `r advdate(dayone, 7, assignment="monday")`
  - Finish Unessay 1 due on `r advdate(dayone, 9, assignment="monday")`
- [ ] `r advdate(dayone, 9, topic)`
  - Finish Lab 9 by `r advdate(dayone, 7, assignment="friday")`
  - Finish  portfolio piece 4 by `r advdate(dayone, 10, assignment="monday")`
- [ ] `r advdate(dayone, 10, topic)`
  - Finish Lab 10 by `r advdate(dayone, 10, assignment="monday")`
- [ ] `r advdate(dayone, 11, topic)`
  - Finish Lab 11 by `r advdate(dayone, 10, assignment="friday")`
  - Finish portfolio piece 5 by `r advdate(dayone, 12, assignment="monday")`
- [ ] `r advdate(dayone, 12, topic)`
  - Finish Lab 12 by `r advdate(dayone, 11, assignment="monday")`
  - Finish portfolio piece 6 by `r advdate(dayone, 13, assignment="monday")`
- [ ] `r advdate(dayone, 13, topic)`
  - Finish portfolio pieces 7 and 8 by `r advdate(dayone, 14, assignment="monday")`
- [ ] `r advdate(dayone, 14, topic)`
  - Finish portfolio piece 9 by `r advdate(dayone, 15, assignment="monday")`
- [ ] `r advdate(dayone, 15, topic)`
  - Finish portfolio piece 10 by `r advdate(dayone, 16, assignment="monday")`
  - Finish Unessay 2 due on `r advdate(dayone, 16, assignment="monday")`
- [ ] Portfolio completion and end-of-semester presentation
  - Due on `r advdate(dayone, 15, assignment="Thursday")`
